...
namespace FinialProject.Framework.Scenes
{
    public abstract class Scene : IScene
    {
        ...
        protected Scene(IMainGame game)
            : this(game, null, Color.CornflowerBlue)
        { }

        protected Scene(IMainGame game, Texture2D sceneTexture)
            : this(game, sceneTexture, Color.CornflowerBlue)
        { }

        protected Scene(IMainGame game, Color backgrounColor)
            : this(game, null, backgrounColor)
        { }

        protected Scene(IMainGame game, Texture2D sceneTexture, Color backgroundColor)
        {
            this.Game = game;
