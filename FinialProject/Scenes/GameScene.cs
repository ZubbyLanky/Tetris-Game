...
using FinialProject.Sprites;
using FinialProject.Framework.Sounds;
using Microsoft.Xna.Framework.Audio;
using FinialProject.Framework.Components;
using FinialProject.Framework.Sprites;
...
namespace FinialProject.Scenes
{
    internal sealed class GameScene : Scene, IGameScene
    {
        ...
        public GameScene(IMainGame game)
            : base(game)
        {
        ...
        {
            _font = contentManager.Load<SpriteFont>("Fonts\\File");
            ...
            //added by Nzube
            //var testSound = contentManager.Load<object>("Sounds\\bgm2");
            //Console.WriteLine(testSound.GetType().Name);
